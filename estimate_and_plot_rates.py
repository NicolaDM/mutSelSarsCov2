...
#Infer mutation rates and selection at synonymous sites and print plots.
#Example run command line: python3 estimate_and_plot_rates.py --path /example_path/coronavirus/mutation_selection/
...
parser.add_argument("--lowestCount", help="count of alternative allele above which to count mutation events (default 0), only used for some of the plots", type=int, default=0)
args = parser.parse_args()

pathSimu=args.path
lowestCount=args.lowestCount

alleles={"A":0,"C":1,"G":2,"T":3}
allelesList=["A","C","G","T"]

#collect reference
file=open(pathSimu+"MN908947.3.fasta")
line=file.readline()
ref=""
while line!="":
	line=file.readline()
...
#Now using Wuhan/Hu-1/2019|EPI_ISL_402125|19-12-26	 as reference
#print(len(ref))
#ref=ref[:8885]+"A"+ref[8886:]
#print(len(ref))
